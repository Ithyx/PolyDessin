...
describe('PolygonService', () => {
  ...
  it('#draw devrait appeler drawStroke si chosenOption n\'est pas Plein', () => {
  ...
  it('#draw devrait appeler drawStroke si chosenOption est Plein', () => {
  ...
  it('#drawShape devrait attribuer le bon svg au polygone si chosenOption est Contour', () => {
    ...
    const svg = '<polygon transform=" matrix(1 0 0 1 0 0)" fill="none" stroke="none" stroke-width="10"'
    + ' points="50 0 100 100 0 100 "></polygon>';
    element.drawShape();
  ...
  it('#drawShape devrait attribuer le bon svg au polygone si chosenOption est Plein', () => {
    element.chosenOption = 'Plein';
    const svg = '<polygon transform=" matrix(1 0 0 1 0 0)" fill="rgba(65, 65, 65, 1)" stroke="none" stroke-width="10"'
    + ' points="50 0 100 100 0 100 "></polygon>';
    element.drawShape();
    expect(element.svg).toEqual(svg);
  });
