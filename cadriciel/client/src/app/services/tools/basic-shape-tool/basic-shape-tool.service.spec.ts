...
describe('BasicShapeToolService', () => {
  ...
  it('should be created', () => {
    const testService: BasicShapeToolService = TestBed.get(RectangleToolService);
    expect(testService).toBeTruthy();
  });
  it('#constructor devrait appeler clear', () => {
    const spy = spyOn(RectangleToolService.prototype, 'clear');
    service = new RectangleToolService(
      service['stockageSVG'], service['tools'], service['colorParameter'], service['commands']
    );
